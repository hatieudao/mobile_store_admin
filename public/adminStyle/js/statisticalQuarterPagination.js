...
console.log("statisticalDatePagination urlParams:", urlParams.toString());
...
function loadPageLink(){
    console.log("statisticalDatePagination load ")
    //Lấy ra current page
...
$(document).ready(function() {
    console.log("statisticalDatePagination add class")
...
$("#pagination").on('click', '.page-link', function(e) {
    ...
    //Url của API
    const urlApi = "/admin/api" + "/statistical/quarter" + "?"+ filter;
    console.log("urlApi sta page: ", urlApi);
    ...
    $.ajax({
        // url: "/admin/api/statistical?page=1",
        url: urlApi,
        success: function (data){
            console.log("stasti page ajax")
            ...
            tableData.html(tableDataTemplate({statistics}));
