...
console.log("statisticalWeekPagination urlParams:", urlParams.toString());
...
function loadPageLink(){
    console.log("statisticalWeekPagination load ")
    //Lấy ra current page
...
$(document).ready(function() {
    console.log("statisticalWeekPagination add class")
...
$("#pagination").on('click', '.page-link', function(e) {
    ...
    //Url của API
    const urlApi = "/admin/api" + "/statistical/week" + "?"+ filter;
